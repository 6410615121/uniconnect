        ...
        <View style={styles.postbox}>
          <View style={{flexDirection:'column'}}>
            ...
            <View style={{height:'20%'}}>
              <Text style={{fontSize:10, color:'#FC6736',textAlign:'right',marginRight:30}}>{post_data.likeCount} Likes {post_data.commentcounts} Comments</Text><Text style={{fontSize:10, color:'#FC6736',textAlign:'right',marginRight:30}}>{post_data.likeCount} Likes {post_data.commentcounts} Comments</Text>
            </View>
          </View>
        </View>
